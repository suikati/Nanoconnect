...
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/node-mock-http@1.0.2/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/unstorage@1.17.0_db0@0.3.2_ioredis@5.7.0/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/unstorage@1.17.0_db0@0.3.2_ioredis@5.7.0/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
...
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/unhead@2.0.14/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/unhead@2.0.14/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/suikati/Nanoconnect/node_modules/.pnpm/unhead@2.0.14/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/suikati/Nanoconnect/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/suikati/Nanoconnect","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/suikati/Nanoconnect/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/suikati/Nanoconnect/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/suikati/Nanoconnect/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/suikati/Nanoconnect/.data/kv"}));
...
const rootDir = "/home/suikati/Nanoconnect";
...
const _RIYwG3bV6oPW9VwHwWomGNvEqgjn_QslzJ0A4pK3qU = (nitroApp) => {
...
const _zWOXb4 = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/suikati/Nanoconnect/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/suikati/Nanoconnect/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_Le40_l, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Le40_l, lazy: true, middleware: false, method: undefined }
];
...
function buildPlaybyplayPrompt(title, choices) {
  ...
  return `\u3042\u306A\u305F\u306F\u30CA\u30CE\u30B3\u30CD\u30AF\u30C8\u682A\u5F0F\u4F1A\u793E\u306E\u8AAC\u660E\u4F1A\u3067\u53F8\u4F1A\u3092\u52D9\u3081\u308B\u30EA\u30F3\u30AB\u3055\u3093\u3067\u3059\u3002\u4EE5\u4E0B\u306E\u30A2\u30F3\u30B1\u30FC\u30C8\u30BF\u30A4\u30C8\u30EB\u3068\u5404\u9078\u629E\u80A2\u306E\u5272\u5408\u3092\u53C2\u7167\u3057\u30011\u301C2\u6587\u3067\u76DB\u308A\u4E0A\u3052\u308B\u305F\u3081\u306E\u77ED\u3044\u5B9F\u6CC1\u3092\u4F5C\u6210\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u63A5\u6226\u306E\u5834\u5408\u306F\u300C\u63A5\u6226\u300D\u3068\u660E\u8A18\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u51FA\u529B\u306F\u5FC5\u305A\u65E5\u672C\u8A9E\u306E\u81EA\u7136\u306A\u6587\u7AE0\u3067\u3001\u5185\u90E8\u306E\u63A8\u8AD6\u3084\u601D\u8003\u904E\u7A0B\u306F\u542B\u3081\u305A\u3001\u5B9F\u6CC1\u306E\u6587\u7AE0\u306E\u307F\u8A18\u8F09\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u3002(\u4F8B)\u300C\u4F55\u306E\u679C\u7269\u304C\u597D\u304D\uFF1F\u300D\u2192\u300C\u6843\u3068\u30EC\u30E2\u30F3\u306E\u63A5\u6226\u3067\u3059\uFF01\u6700\u5F8C\u306B\u52DD\u3064\u306E\u306F\u7518\u515A\u3067\u3057\u3087\u3046\u304B\u3001\u9178\u3063\u3071\u515A\u3067\u3057\u3087\u3046\u304B\uFF01\u300D
\u30BF\u30A4\u30C8\u30EB: ${title}
${lines.join("\n")}`;
}
function buildCommentPrompt(title, selectedText) {
  return `\u3042\u306A\u305F\u306F\u30CA\u30CE\u30B3\u30CD\u30AF\u30C8\u682A\u5F0F\u4F1A\u793E\u306E\u30DE\u30B9\u30B3\u30C3\u30C8\u30AD\u30E3\u30E9\u30AF\u30BF\u30FC\u306E\u30CA\u30CE\u3059\u3051\u3067\u3059\u3002\u30A2\u30F3\u30B1\u30FC\u30C8\u306E\u30BF\u30A4\u30C8\u30EB: "${title}" \u306B\u5BFE\u3057\u3066\u3001\u30E6\u30FC\u30B6\u30FC\u304C\u9078\u3093\u3060\u9078\u629E\u80A2: "${selectedText}" \u306B\u5408\u308F\u305B\u305F\u89AA\u3057\u307F\u3084\u3059\u3044\u77ED\u3044\u65E5\u672C\u8A9E\u30B3\u30E1\u30F3\u30C8\uFF081\u6587\uFF09\u3092\u8FD4\u3057\u3066\u304F\u3060\u3055\u3044\u3002\u30B3\u30E1\u30F3\u30C8\u306E\u6700\u5F8C\u306F\u300C\u301C\u30CA\u30CE\uFF01\u300D\u307E\u305F\u306F\u300C\uFF5E\u30CE\uFF01\u300D\u306E\u8A9E\u5442\u304C\u826F\u3044\u65B9\u3067\u7DE0\u3081\u3066\u304F\u3060\u3055\u3044\u3002\u51FA\u529B\u306F\u5FC5\u305A\u65E5\u672C\u8A9E\u306E\u81EA\u7136\u306A\u6587\u7AE0\u3067\u3001\u5185\u90E8\u306E\u63A8\u8AD6\u3084\u601D\u8003\u904E\u7A0B\u306F\u542B\u3081\u305A\u3001\u6307\u5B9A\u5916\u306E\u60C5\u5831\u306F\u8A18\u8F09\u3057\u306A\u3044\u3067\u304F\u3060\u3055\u3044\u3002(\u4F8B)\u30BF\u30A4\u30C8\u30EB\uFF1A\u300C\u4F55\u8272\u304C\u597D\u304D\uFF1F\u300D\u9078\u629E\uFF1A\u300C\u8D64\u8272\u300D\u30B3\u30E1\u30F3\u30C8(\u51FA\u529B)\uFF1A\u300C\u60C5\u71B1\u7684\u30CA\u30CE\uFF01\u300D`;
}
async function handler(event) {
  ...
  if (isComment) {
    const req2 = body;
    try {
      console.debug("openai comment request", { title: req2.title, selectedChoice: req2.selectedChoice ? typeof req2.selectedChoice === "string" ? req2.selectedChoice.slice(0, 100) : "[object]" : req2.selectedChoice });
    } catch (e) {
    }
    ...
    if (!selectedText || String(selectedText).trim() === "") {
      return { text: "\u3044\u3044\u30C1\u30E7\u30A4\u30B9\u30CA\u30CE\uFF01", meta: { model: "none" } };
    }
    const commentKeyBase = JSON.stringify({ title: req2.title, selectedText });
    const commentCacheKey = createHash("sha256").update(commentKeyBase).digest("hex");
    globalThis.__OPENAI_CACHE = globalThis.__OPENAI_CACHE || /* @__PURE__ */ new Map();
    const cachedComment = globalThis.__OPENAI_CACHE.get(commentCacheKey);
    if (cachedComment) return cachedComment;
    const client2 = getOpenAI();
    const prompt2 = buildCommentPrompt(req2.title, String(selectedText));
    try {
      const result = await client2.responses.create({
        model: MODEL,
        input: prompt2,
  ...
  if (totalVotes === 0) {
    return { text: "\u307E\u3060\u6295\u7968\u304C\u3042\u308A\u307E\u305B\u3093\u3002\u6295\u7968\u7D50\u679C\u304C\u51FA\u305F\u3089\u5B9F\u6CC1\u3057\u307E\u3059\uFF01", meta: { model: "none" } };
  }
  ...
  globalThis.__OPENAI_CACHE = globalThis.__OPENAI_CACHE || /* @__PURE__ */ new Map();
  const cached = globalThis.__OPENAI_CACHE.get(cacheKey);
