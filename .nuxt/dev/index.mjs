...
function buildPlaybyplayPrompt(title, choices, tone) {
...
async function handler(event) {
  ...
  if (isComment) {
    const req2 = body;
    if (!req2.title || !req2.selectedChoice) {
    ...
    try {
      ...
      const text = (_i = (_h = (_g = (_f = (_e = result.choices) == null ? void 0 : _e[0]) == null ? void 0 : _f.message) == null ? void 0 : _g.content) == null ? void 0 : _h.trim()) != null ? _i : "\u30CA\u30CE\u3059\u3051\u304C\u5C11\u3057\u7720\u3044\u30CA\u30CE\u2026";
      ...
      if ((_j = event == null ? void 0 : event.node) == null ? void 0 : _j.res) event.node.res.statusCode = 500;
  ...
  const prompt = buildPlaybyplayPrompt(req.title, req.choices, req.tone);
  try {
    ...
    const text = (_p = (_o = (_n = (_m = (_l = result.choices) == null ? void 0 : _l[0]) == null ? void 0 : _m.message) == null ? void 0 : _n.content) == null ? void 0 : _o.trim()) != null ? _p : "";
    const out = { text, meta: { model: result.model } };
    ...
    if ((_q = event == null ? void 0 : event.node) == null ? void 0 : _q.res) event.node.res.statusCode = 500;
    return { error: "openai_error", detail: String((err == null ? void 0 : err.message) || err) };
  }
}
