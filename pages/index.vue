          ...
          <div class="space-y-5">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
              ...
              <div class="flex-1 flex items-center gap-2">
                <input v-model="presenterJoinCode" placeholder="または既存コードで入室('test'にダミーデータを用意しています)" class="flex-1 border border-primary-200 focus:border-primary-400 focus:ring-2 focus:ring-primary-300/60 rounded-lg px-3 py-2 text-xs sm:text-sm bg-white/70" />
        ...
        <UiCard variant="glass" padding="lg" interactive>
          ...
          <div class="space-y-5">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
              <input
                v-model="codeInput"
                placeholder="ルームコードを入力('test'にダミーデータを用意しています)"
